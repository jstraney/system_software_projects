...
// NOTE changed this here due to an "off by one" issue that cascaded down
// my code. assumed this whole time that lex levels would be 3 (including main)
// but can see examples having 4 levels including main.
#define VM_MAX_LEXI_LEVEL             4 
